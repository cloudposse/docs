...
The most common pattern we deploy is supporting [`aws-spa-s3-cloudfront`](https://github.com/cloudposse-terraform-components/aws-spa-s3-cloudfront). We’ll need to know if this is a pattern you intend to utilize, as it has an impact on the strategies for CI/CD. Each strategy will at a minimum require a different terraform component.
