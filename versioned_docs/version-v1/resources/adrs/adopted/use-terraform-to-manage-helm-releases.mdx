...
sidebar_label: "Terraform to Manage Helm Releases"
---
...
- Modify any deployed resource via `kubectl edit` and observe that that change is <i>not</i> detected by Terraform.
