...
[GitHub Action Runner Controller setup docs](/layers/github-actions/tutorials/eks-github-actions-controller/).

### Self Hosted Github Runners with Philips Labs (ECS)

If you have chosen ECS as a platform, we recommend deploying Philips Labs GitHub Action Runners. Please read through the [Philips Labs GitHub Action Runners Setup Requirements](/layers/github-actions/tutorials/philips-labs-github-runners/).
