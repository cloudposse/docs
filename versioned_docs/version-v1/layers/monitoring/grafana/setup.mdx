...
<Steps>
  <Step>
    ...
    <AtmosWorkflow workflow="vendor" fileName="quickstart/monitor/grafana" />

  </Step>

  <Step>
    ## <StepNumber/> Deploy Grafana and the Prometheus Scraper
    ...
    <AtmosWorkflow workflow="deploy" fileName="quickstart/monitor/grafana" />
