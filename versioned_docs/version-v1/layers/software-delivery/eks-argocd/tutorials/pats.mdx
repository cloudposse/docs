...
<Steps>
  ...
  <Step>
    ...
    <Steps>
      ...
      3. Grant this PAT the following permissions
          ...
          <AtmosWorkflow workflow="deploy/terraform-argocdrepo-pat" fileName="quickstart/app/argocd" />
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="argocd-repos" fileName="quickstart/app/argocd" />
  ...
  <Step>
    ...
    <Steps>
      ...
      4. Use the following workflow to upload this PAT to AWS SSM:
          ...
          <AtmosWorkflow workflow="deploy/terraform-webhooks-nonprod-pat" fileName="quickstart/app/argocd" />
    ...
    <Steps>
      ...
      4. Use the following workflow to upload this PAT to AWS SSM:
          ...
          <AtmosWorkflow workflow="deploy/terraform-webhooks-prod-pat" fileName="quickstart/app/argocd" />
  ...
  <Step>
    ...
    <Steps>
      ...
      3. Then check that the bot user has access to the _application_ repo. For example for Cloud Posse, that is [cloudposse-examples app-on-eks-with-argo](https://github.com/cloudposse-examples/app-on-eks-with-argocd).
         ...
         <AtmosWorkflow workflow="deploy/app-notifications-pat" fileName="quickstart/app/argocd" />
