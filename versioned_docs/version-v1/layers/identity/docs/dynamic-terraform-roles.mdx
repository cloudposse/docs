...
<Intro>
This document describes the Dynamic Terraform Roles feature and its benefits, and, for users of the previous architecture, **how to migrate to it**. The [AWS Access Control Architecture](/layers/identity/tutorials/access-control-evolution/) documentation assumes this feature is enabled and describes how to use it. The [AWS Access Control Evolution](/layers/identity/tutorials/access-control-evolution/) documentation describes the feature in more detail.
</Intro>
...
[AWS Access Control Evolution -> Dynamic Terraform Roles...](/layers/identity/tutorials/access-control-evolution/).
...
[AWS Access Control Architecture](/layers/identity/tutorials/access-control-evolution/),
especially [the section on Terraform Support](/layers/identity/tutorials/access-control-evolution/).
...
the [AWS Access Control Evolution](/layers/identity/tutorials/access-control-evolution/)
