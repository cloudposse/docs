...
If we are not deploying EKS for our platform, it doesn't make much sense to configure EKS solely for self-hosted runners. Instead, we deploy the [Philips Labs Action Runners](/layers/github-actions/tutorials/philips-labs-github-runners/) and connect those instances to GitHub.
