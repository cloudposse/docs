...
<Steps>
  <Step>
    ...
    <AtmosWorkflow workflow="vendor/philips-labs" fileName="quickstart/foundation/github" />
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="upload/pl-secrets" fileName="quickstart/foundation/github" />
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/pl-github-runners" fileName="quickstart/foundation/github" />
  ...
  <Step>
    ...
    <Steps>
      1. Open the GitHub App created in
        [Create the GitHub App above](/layers/github-actions/tutorials/philips-labs-github-runners/)
