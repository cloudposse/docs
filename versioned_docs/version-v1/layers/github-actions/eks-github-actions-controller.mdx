...
<Note title="Important">We recommend using ARC only if your organization uses Kubernetes, otherwise we recommend the [Philips Labs GitHub Runner](/layers/github-actions/tutorials/philips-labs-github-runners/) approach instead.</Note>
...
| 4. Deploy cluster and resources into the `auto` stack | `atmos workflow deploy/github-runners -f quickstart/foundation/github`                |
...
<Steps>
  ...
  <Note title="Tip">
    ...
    <AtmosWorkflow workflow="deploy/arc-github-runners" fileName="quickstart/foundation/github" />
  </Note>
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/cluster" fileName="quickstart/platform/eks" stack="core-use1-auto"/>
    <AtmosWorkflow workflow="deploy/resources" fileName="quickstart/platform/eks" stack="core-use1-auto"/>
