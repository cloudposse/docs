...
We will prioritize reviewing your PRs in the `#pr-reviews` channel and assist you with LGTM as soon as possible. Feel free to DM to `@Erik Osterman` or `@Igor Rodionov` in Slack with any questions or feedback. 

:::tip Join the Conversation!
Want to help shape the future of our Terraform components?  
We're building it *in the open* and you're invited.  
