...
<Steps>
  ...
  <Step>
    ...
    <Admonition>
      These are the design decisions you can customize as part of the Quickstart package. [All other decisions are pre-made](/tags/design-decision/) for you, but you’re welcome to review them. If you’d like to make additional changes, [let us know—we’re happy to provide a quote](https://cloudposse.com/meet).
    </Admonition>
