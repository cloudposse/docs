...
<Steps>
  ...
  <Step>
    ...
    If deploying Spacelift, we will need a Spacelift subscription. Please see [How to Sign Up for Spacelift](/layers/spacelift/spacelift). This document answers many common questions and describes the signup process step-by-step.
