...
<Steps>
  ...
  <Step>
    ...
    <TaskList>
      ...
      - [Component Development](/learn/component-development/component-development)
      ...
      - [Spacelift](/layers/spacelift/spacelift) or [GitOps](/layers/gitops/gitops)
      - [ECS](/layers/ecs/ecs) or [EKS](/layers/eks/eks)
      - [Monitoring](/layers/monitoring/monitoring) and [Alerting](/layers/alerting/alerting)
      - [Release Engineering](/layers/software-delivery/software-delivery)
      - Final Call (Sign-off)
    </TaskList>
  </Step>
</Steps>
