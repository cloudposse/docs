...
5. `stacks/catalog/usecases/disabled.yaml` - Predefined file for `disabled` configuration usescase (when variable `enabled: false`)
...
|`go test -timeout 1h --skip-deploy-dependencies --skip-destroy-dependencies --skip-destroy-component`                        | Deploy testing component. Use previously deployed dependencies. Do not destroy anything. Usefull when you are working on deploing usecase |
|`go test -timeout 1h --skip-deploy-dependencies --skip-destroy-dependencies --skip-deploy-component --skip-destroy-component`| Do not deploy or destroy anything. Usefull when you are working on tests asserts                                                          |
|`go test -timeout 1h --skip-deploy-dependencies --skip-deploy-component`                                                     | Destroy component and it's dependencies. Usefull when your tests are done to clean up all resourecs                                       |
...
<Step>
  ...
  <Steps>
    ...
    1. Import the usecase for `default-test` stack
...
<Step>
  ...
  <Steps>
  1. Add atmos configuration for the component usecase
