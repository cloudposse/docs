...
|`go test -timeout 1h --skip-deploy-dependencies --skip-deploy-component`                                                     | Destroy component and it's dependencies. Useful when your tests are done to clean up all resources                                       |
