---
title: "How to Move `atmos-gitops-config.yaml` to `atmos.yaml`"
sidebar_label: "Upgrade GitOps V2 config"
sidebar_position: 100
description: "Migrate guide for v1 to v2 GitOps configuration"
---
