...
- [Archived Decisions](/resources/legacy/design-decisions/archived-decisions/archived-decisions)
- [Decide on Datadog Log Forwarding Requirements](/layers/monitoring/design-decisions/decide-on-datadog-log-forwarding-requirements)
...
- [Decide on Cognito Requirements](/resources/legacy/design-decisions/decide-on-cognito-requirements)
- [Decide on Kinesis Requirements](/resources/legacy/design-decisions/decide-on-kinesis-requirements)
- [Decide on CloudFront Requirements](/resources/legacy/design-decisions/decide-on-cloudfront-requirements)
- [Decide on KMS Requirements](/resources/legacy/design-decisions/decide-on-kms-requirements)
...
- [Decide on Strategy for Managing and Orchestrating Secrets](/layers/software-delivery/design-decisions/decide-on-strategy-for-managing-and-orchestrating-secrets)
- [Decide on API Gateway Requirements](/resources/legacy/design-decisions/decide-on-api-gateway-requirements)
- [Decide on IPv4 and IPv6 support](/layers/network/design-decisions/decide-on-ipv4-and-ipv6-support)
