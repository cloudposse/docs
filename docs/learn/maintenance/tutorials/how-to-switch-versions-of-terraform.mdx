...
First, make sure you’ve installed the latest version of `terraform` in [Geodesic](/reference/legacy/fundamentals/geodesic) by following our guide [How to Upgrade or Install Versions of Terraform](/learn/maintenance/upgrades/how-to-upgrade-or-install-versions-of-terraform).
