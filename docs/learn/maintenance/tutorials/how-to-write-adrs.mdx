...
The source of truth for ADRs is primarily the corresponding Design Decisions. We can also borrow from our ADRs to our repo [https://github.com/cloudposse/adr](https://github.com/cloudposse/adr) and the Design Decisions context from our Reference Architecture confluence.
