...
You can see examples of this pattern in the [dns-primary](https://github.com/cloudposse-terraform-components/aws-dns-primary), [dns-delegated](https://github.com/cloudposse-terraform-components/aws-dns-delegated) and [iam-primary-roles](https://github.com/cloudposse/terraform-aws-components/tree/main/deprecated/iam-primary-roles)  / [iam-delegated-roles](https://github.com/cloudposse/terraform-aws-components/tree/main/deprecated/iam-delegated-roles)  components.
