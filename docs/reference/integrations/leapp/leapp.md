...
Your organization is already set up with either the [sso](/components/library/aws/aws-sso/) or the
...
<img src="/assets/refarch/image-20211027-143855.png" height="1296" width="1030" /><br/>
...
- The “AWS Region” you set in the Leapp session should be the AWS Region you most often use, as discussed
  [above](/howto/geodesic/authenticate-with-leapp/#aws-region-and-credentials).
...
<img src="/assets/refarch/image-20211027-144503.png" height="1288" width="1018" /><br/>
