...
1. **GuardDuty enabled**: Follow the [GuardDuty setup guide](/layers/security-and-compliance/aws-guardduty/)
2. **EKS clusters deployed**: Have at least one EKS cluster running
3. **Delegated administrator configured**: GuardDuty organization settings deployed
