...
│  │  SINGLE STEP: Enable Audit Manager + Delegate Administration           │ │
│  │  - Enables Audit Manager in the organization                           │ │
│  │  - Delegates administration to security account                        │ │
...
│  │  - Receives delegation automatically                                   │ │
...
│  │  - CloudTrail, Config, Security Hub data aggregated                   │ │
│  └────────────────────────────────────────────────────────────────────────┘ │
└─────────────────────────────────────────────────────────────────────────────┘
```
