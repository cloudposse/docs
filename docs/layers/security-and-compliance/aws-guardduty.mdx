...
│  │  STEP 2: Delegate GuardDuty administration to security account         │ │
│  │  - Creates: aws_guardduty_organization_admin_account                   │ │
...
│  │  STEP 1 (FIRST): Create GuardDuty detector (admin_delegated: false)    │ │
│  │  - Creates: aws_guardduty_detector                                     │ │
│  │                                                                        │ │
│  │  STEP 3 (LAST): Configure org settings (admin_delegated: true)         │ │
│  │  - Creates: aws_guardduty_organization_configuration                   │ │
│  │  - Enables protection features, auto-enrolls members                   │ │
│  └────────────────────────────────────────────────────────────────────────┘ │
│                              ▲                                              │
│                              │ Findings                                     │
│  ┌────────────────────────────────────────────────────────────────────────┐ │
