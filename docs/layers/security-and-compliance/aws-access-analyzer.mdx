...
│  │  STEP 1: Delegate Access Analyzer administration                       │ │
│  │  - Creates: aws_organizations_delegated_administrator                  │ │
│  │  - Creates: aws_iam_service_linked_role (if enabled)                   │ │
...
│  │  STEP 2: Create organization analyzers                                 │ │
│  │  - Creates: aws_accessanalyzer_analyzer (ORGANIZATION)                 │ │
│  │  - Creates: aws_accessanalyzer_analyzer (ORGANIZATION_UNUSED_ACCESS)   │ │
│  │                                                                        │ │
│  │  ┌──────────────────────────────────────────────────────────────────┐  │ │
...
│  ┌────────────────────────────────────────────────────────────────────────┐ │
│  │  Member Accounts                                                       │ │
│  │  - Resources automatically analyzed                                    │ │
│  │  - No per-account configuration required                              │ │
