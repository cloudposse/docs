...
flowchart TB
    subgraph org["AWS Organization"]
        subgraph audit["Audit Account"]
            ...
            bucket["cloudtrail-bucket (S3)"]
            logs["CloudWatch Log Group"]
            kms["KMS Key (optional)"]
        end

        subgraph members["All Member Accounts"]
            member1["Account 1<br/>Auto-included"]
            member2["Account 2<br/>Auto-included"]
            member3["Account N<br/>Auto-included"]
        end
    end

    member1 -->|"API Activity Logs"| trail
    member2 -->|"API Activity Logs"| trail
    member3 -->|"API Activity Logs"| trail
    trail --> bucket
    trail --> logs
```
