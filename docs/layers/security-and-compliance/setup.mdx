...
<Steps>
  <Step>
    ...
    <AtmosWorkflow workflow="vendor" fileName="quickstart/monitor/compliance" />
  </Step>
...
<Steps>
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/aws-config/global-collector" fileName="quickstart/monitor/compliance" />
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/aws-config/superadmin" fileName="quickstart/monitor/compliance" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/security-hub/step1" fileName="quickstart/monitor/compliance" />
  </Step>
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/security-hub/step2" fileName="quickstart/monitor/compliance" />
  </Step>
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/security-hub/step3" fileName="quickstart/monitor/compliance" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/guardduty/step1" fileName="quickstart/monitor/compliance" />
  </Step>
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/guardduty/step2" fileName="quickstart/monitor/compliance" />
  </Step>
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/guardduty/step3" fileName="quickstart/monitor/compliance" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/route53-resolver-dns-firewall-buckets" fileName="quickstart/monitor/compliance" />
  </Step>
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/route53-resolver-dns-firewall" fileName="quickstart/monitor/compliance" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/aws-shield" fileName="quickstart/monitor/compliance" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/aws-inspector2/step1" fileName="quickstart/monitor/compliance" />
  </Step>
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/aws-inspector2/step2" fileName="quickstart/monitor/compliance" />
  </Step>
</Steps>
