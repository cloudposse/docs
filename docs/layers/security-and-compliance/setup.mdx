...
<Steps>
  <Step>
    ...
    <AtmosWorkflow workflow="vendor" fileName="quickstart/monitor/security-and-compliance" />
  </Step>
  ...
  <Step>
    ...
    <Note title="Reminder">
      The following command requires a privileged role with access to the root account. Use an appropriate Permission Set (e.g., `AdministratorAccess` on `core-root`) or, if deploying during cold start, [SuperAdmin](/layers/accounts/tutorials/how-to-create-superadmin-user/). Ensure the `plan` output only touches service principals.
    </Note>
  ...
  <Step>
    ...
    <Admonition type="info">
      This bucket has likely been provisioned by the [Cold Start](/layers/accounts/setup-cloudtrail/). Run the following `terraform plan` to ensure the bucket exists. If it doesn't, create it with `terraform apply`.
    </Admonition>
...
<Steps>
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/aws-config/global-collector" fileName="quickstart/monitor/security-and-compliance" />

    <Note title="Reminder">
      This command requires a privileged role with access to the root account. Use an appropriate Permission Set or, if deploying during cold start, [`SuperAdmin`](/layers/accounts/tutorials/how-to-create-superadmin-user/).
    </Note>
  </Step>

  <Step>
    ### <StepNumber/> Set up AWS Config for Privileged Accounts

    Deploy AWS Config into accounts that require privileged access to apply.

    <AtmosWorkflow workflow="deploy/aws-config/superadmin" fileName="quickstart/monitor/security-and-compliance" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/security-hub/step1" fileName="quickstart/monitor/security-and-compliance" />
  </Step>
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/security-hub/step2" fileName="quickstart/monitor/security-and-compliance" />
  </Step>
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/security-hub/step3" fileName="quickstart/monitor/security-and-compliance" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/guardduty/step1" fileName="quickstart/monitor/security-and-compliance" />
  </Step>
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/guardduty/step2" fileName="quickstart/monitor/security-and-compliance" />
  </Step>
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/guardduty/step3" fileName="quickstart/monitor/security-and-compliance" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/route53-resolver-dns-firewall-buckets" fileName="quickstart/monitor/security-and-compliance" />
  </Step>
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/route53-resolver-dns-firewall" fileName="quickstart/monitor/security-and-compliance" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/aws-shield" fileName="quickstart/monitor/security-and-compliance" />
  </Step>
</Steps>
...
<Steps>
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/aws-inspector2/step1" fileName="quickstart/monitor/security-and-compliance" />
  </Step>
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/aws-inspector2/step2" fileName="quickstart/monitor/security-and-compliance" />
  </Step>
</Steps>
