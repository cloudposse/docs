...
<Steps>
  <Step>
    ...
    ```bash
    atmos terraform apply cloudtrail -s core-ue1-audit
    ```
  </Step>
</Steps>
...
<Steps>
  <Step>
    ...
    ```bash
    atmos terraform apply aws-config-ue1 -s core-ue1-security
  ...
  <Step>
    ...
    ```bash
    atmos terraform apply aws-config-ue1 -s core-ue1-root
