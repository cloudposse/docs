...
```mermaid
flowchart LR
    subgraph phase1["Phase 1: Org-Level Config"]
    ...
    subgraph phase3["Phase 3: Threat Detection"]
...
<Steps>
  ...
  <Step>
    ...
    Deploy only one aws-config-bucket per organization. It stores data from all accounts and regions.
    </Note>
