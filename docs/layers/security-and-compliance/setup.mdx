...
:::tip Workflow Recovery

If a step in any workflow fails, you can restart from that failed step:

```bash
atmos workflow deploy/aws-config/global-collector -f quickstart/monitor/security-and-compliance --from-step step4
```
...
```bash
# Vendor all security components
atmos workflow vendor -f quickstart/monitor/security-and-compliance
```
...
<Steps>
  ...
  <Step>
    ...
    ```bash
    atmos terraform apply config-bucket -s core-use1-audit
    ```
  </Step>
  ...
  <Step>
    ...
    atmos terraform plan cloudtrail-bucket -s core-use1-audit
    atmos terraform apply cloudtrail-bucket -s core-use1-audit
    ```
  </Step>
...
```bash
# Deploy AWS Config to all regions (security account)
atmos workflow deploy/aws-config/global-collector -f quickstart/monitor/security-and-compliance

# Deploy AWS Config to root accounts (requires root access)
atmos workflow deploy/aws-config/superadmin -f quickstart/monitor/security-and-compliance
```
...
<Steps>
  <Step>
    ...
    ```bash
    atmos terraform apply cloudtrail -s core-use1-audit
    ```
  </Step>
</Steps>
...
<Steps>
  <Step>
    ...
    ```bash
    # Deploy to all regions in the security account
    atmos workflow deploy/aws-config/global-collector -f quickstart/monitor/security-and-compliance
    ```

    Or deploy manually to specific regions:

    ```bash
    atmos terraform apply aws-config-use1 -s core-use1-security
    atmos terraform apply aws-config-use2 -s core-use2-security
    atmos terraform apply aws-config-usw2 -s core-usw2-security
  ...
  <Step>
    ...
    ```bash
    # Deploy to all regions in the root account
    atmos workflow deploy/aws-config/superadmin -f quickstart/monitor/security-and-compliance
    ```
    ...
    ```bash
    atmos terraform apply aws-config-use1 -s core-use1-root
    atmos terraform apply aws-config-use2 -s core-use2-root
    # ... repeat for each region
    ```
  </Step>
</Steps>
...
```bash
# GuardDuty (3 steps)
atmos workflow deploy/guardduty/step1 -f quickstart/monitor/security-and-compliance
atmos workflow deploy/guardduty/step2 -f quickstart/monitor/security-and-compliance  # requires root access
atmos workflow deploy/guardduty/step3 -f quickstart/monitor/security-and-compliance

# Inspector (2 steps)
atmos workflow deploy/aws-inspector2/step1 -f quickstart/monitor/security-and-compliance  # requires root access
atmos workflow deploy/aws-inspector2/step2 -f quickstart/monitor/security-and-compliance
```
...
<Steps>
  <Step>
    ...
    ```bash
    atmos terraform apply aws-inspector2/delegate-orgadmin/ue1 -s core-ue1-root
    ```
  </Step>
  ...
  <Step>
    ...
    ```bash
    atmos terraform apply aws-inspector2/org-settings/ue1 -s core-ue1-security
    ```
  </Step>
</Steps>
...
```bash
# Security Hub (3 steps)
atmos workflow deploy/security-hub/step1 -f quickstart/monitor/security-and-compliance
atmos workflow deploy/security-hub/step2 -f quickstart/monitor/security-and-compliance  # requires root access
atmos workflow deploy/security-hub/step3 -f quickstart/monitor/security-and-compliance

# Shield (requires subscription)
atmos workflow deploy/aws-shield -f quickstart/monitor/security-and-compliance
```
...
<Steps>
  <Step>
    ...
    atmos terraform apply aws-shield -s plat-use1-prod
    ```
  </Step>
</Steps>
...
<Steps>
  <Step>
    ...
    ```bash
    atmos terraform apply audit-manager -s core-gbl-root
    ```
  </Step>
</Steps>
...
```bash
atmos workflow deploy/route53-resolver-dns-firewall-buckets -f quickstart/monitor/security-and-compliance
atmos workflow deploy/route53-resolver-dns-firewall -f quickstart/monitor/security-and-compliance
```
...
<Steps>
  <Step>
    ...
    ```bash
    atmos terraform apply route53-resolver-dns-firewall-logs -s plat-use1-dev
    atmos terraform apply route53-resolver-dns-firewall-logs -s plat-use1-prod
    atmos terraform apply route53-resolver-dns-firewall-logs -s plat-use1-sandbox
    atmos terraform apply route53-resolver-dns-firewall-logs -s plat-use1-staging
    ```
  </Step>
  ...
  <Step>
    ...
    ```bash
    atmos terraform apply route53-resolver-dns-firewall/dev -s plat-use1-dev
    atmos terraform apply route53-resolver-dns-firewall/prod -s plat-use1-prod
    atmos terraform apply route53-resolver-dns-firewall/sandbox -s plat-use1-sandbox
    atmos terraform apply route53-resolver-dns-firewall/staging -s plat-use1-staging
    ```
  </Step>
</Steps>
