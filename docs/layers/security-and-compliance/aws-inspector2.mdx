...
<Intro>
AWS Inspector provides automated vulnerability scanning for EC2 instances, container images in ECR, and Lambda
...
│  │  STEP 1: Delegate Inspector administration to security account         │ │
│  │  - Creates: aws_inspector2_delegated_admin_account                     │ │
...
│  │  STEP 2: Configure org settings (admin_delegated: true)                │ │
│  │  - Creates: aws_inspector2_organization_configuration                  │ │
│  │  - Enables EC2, ECR, Lambda scanning for all accounts                  │ │
│  │  - Auto-enrolls new member accounts                                    │ │
│  │                                                                        │ │
│  │  ┌──────────────────────────────────────────────────────────────────┐  │ │
│  │  │                    Inspector Dashboard                           │  │ │
│  │  │  ┌──────────┐ ┌──────────┐ ┌──────────┐                         │  │ │
...
│  ┌────────────────────────────────────────────────────────────────────────┐ │
│  │  Member Accounts                                                       │ │
│  │  - Automatically enrolled by delegated administrator                   │ │
│  │  - EC2 instances, ECR images, Lambda functions scanned                │ │
