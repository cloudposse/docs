...
<Tabs queryString="sql">
  <TabItem value="aurora-postgres" label="Aurora PostgreSQL">
    ...
    <PrimaryCTA to="https://github.com/cloudposse-terraform-components/aws-aurora-postgres">Get Started</PrimaryCTA>
  </TabItem>
  ...
  <TabItem value="aurora-mysql" label="Aurora MySQL">
    ...
    <PrimaryCTA to="https://github.com/cloudposse-terraform-components/aws-aurora-mysql">Get Started</PrimaryCTA>
  </TabItem>
  ...
  <TabItem value="rds" label="RDS">
    ...
    <PrimaryCTA to="https://github.com/cloudposse-terraform-components/aws-rds">Get Started</PrimaryCTA>
  </TabItem>
  ...
  <TabItem value="redshift" label="RedShift">
    ...
    <PrimaryCTA to="https://github.com/cloudposse-terraform-components/aws-redshift">Get Started</PrimaryCTA>
  </TabItem>
</Tabs>
...
<Tabs queryString="nosql">
  <TabItem value="dynamodb" label="DynamoDB">
    ...
    <PrimaryCTA to="https://github.com/cloudposse-terraform-components/aws-dynamodb">Get Started</PrimaryCTA>
  </TabItem>
  ...
  <TabItem value="documentdb" label="DocumentDB">
    ...
    <PrimaryCTA to="https://github.com/cloudposse-terraform-components/aws-documentdb">Get Started</PrimaryCTA>
  </TabItem>
  ...
  <TabItem value="elasticache-redis" label="ElastiCache Redis">
    ...
    <PrimaryCTA to="https://github.com/cloudposse-terraform-components/aws-elasticache-redis">Get Started</PrimaryCTA>
  </TabItem>
