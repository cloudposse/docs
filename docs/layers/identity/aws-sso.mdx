...
<Tabs queryString="idp">
  ...
  <TabItem value="microsoft-entra-id" label="Microsoft Entra ID">
    ...
    <Steps>
      ...
      #### <StepNumber overrideNumber={6}/> Similarly, you'll need to download the AWS IAM Identity Center metadata XML file from AWS.
    ...
    <Steps>
      1. In AWS IAM Identity Center, you can set up automatic provisioning by generating a URL and secret
      <img src="/assets/refarch/aws-sso/sso-enable-provisioning.png" />

      2. Go to Your App for Single Sign On in Microsoft Entra ID, on the left Panel go to **Provisioning**

      3. Set the mode to **Automatic** and paste the values from AWS into the **Admin Credentials** Section <img src="/assets/refarch/screen-shot-2023-01-13-at-8.53.55-am.png" /><br/>
