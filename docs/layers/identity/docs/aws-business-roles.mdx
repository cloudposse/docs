---
title: Key AWS Business Roles and Titles
sidebar_label: AWS Business Roles
---
import Intro from '@site/src/components/Intro';

<Intro>
This document provides an overview of the key AWS business roles and titles that you may encounter when working with AWS. Understanding these roles can help you navigate the AWS organization and get the most out of your relationship with AWS.
</Intro>
