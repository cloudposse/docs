...
<Intro>
This document describes the Dynamic Terraform Roles feature and its benefits, and, for users of the previous architecture, **how to migrate to it**. The [AWS Access Control Architecture](./aws-access-control-architecture.md) documentation assumes this feature is enabled and describes how to use it. The [AWS Access Control Evolution](./aws-access-control-evolution.md#dynamic-terraform-roles-normalization-of-team-roles-better-team-and-team-role-iam-policy-management) documentation describes the feature in more detail.
</Intro>
