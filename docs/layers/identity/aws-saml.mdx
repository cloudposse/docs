...
<Steps>
  ...
  <Step>
    ## <StepNumber/> (Optional) Download AWS Extend Switch Roles.

    We use the AWS Extend Switch Roles plugin to make it easier to switch roles in the AWS Console. This is optional, but recommended especially if you are not using AWS IAM Identity Center.
