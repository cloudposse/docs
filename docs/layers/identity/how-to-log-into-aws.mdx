...
{/* TODO:DEPRECATE-ACCOUNT-MAP - REWRITE PAGE - Status: Not Started */}
{/*
## Required Updates:
...
- Update description to mention Atmos Auth instead of Leapp
*/}

:::warning Page Update In Progress
This page is being updated to document **Atmos Auth** as the primary authentication method.

For the new approach, see [Atmos Auth](/layers/identity/atmos-auth) and [Atmos Profiles](/layers/identity/atmos-profiles).
:::
