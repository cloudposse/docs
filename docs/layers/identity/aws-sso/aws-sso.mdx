...
<Tabs>
  ...
  <TabItem value="microsoft365" label="Microsoft 365">
    ...
    <Steps>
      ...
      7. Similarly, in Jumpstarts the Cloud Posse Team will give you an XML file from AWS SSO that contains metadata.
