---
title: "How to Setup Leapp on Windows with WSL"
...
:::warning Deprecated
This documentation describes setting up **Leapp** on Windows, which is being replaced by **Atmos Auth**.

**The recommended approach now uses:**
- **Atmos Auth** for AWS authentication via `atmos auth login`
- **Atmos Profiles** for role selection
...
Please see [How to Log into AWS](/layers/identity/how-to-log-into-aws#setup), skipping all requirement
