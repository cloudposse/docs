...
Consider this example. We want to enable the “DevOps” to assume Administrator in multiple accounts, such as dev or production. However, “developers” can only assume admin in dev. Here’s how that would work:
