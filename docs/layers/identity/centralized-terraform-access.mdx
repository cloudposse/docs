...
```mermaid
flowchart LR
    subgraph identity_account_teams["core-identity Account Teams"]
        developers["developers"]
        devops["devops"]
    end

    subgraph dev_account_roles["plat-dev Account Team Roles"]
        admin_dev["admin"]
    end

    subgraph prod_account_roles["plat-prod Account Team Roles"]
        admin_prod["admin"]
...
### Connect to an Account with Identity Center
