...
In order to deploy Self-Hosted GitHub Runners on EKS, follow the steps outlined in the [EKS setup doc](https://docs.cloudposse.com/reference-architecture/setup/eks/). Those steps will complete the EKS requirements.
...
<Step>
  ### <StepNumber/> Deploy Automation Cluster Resources
