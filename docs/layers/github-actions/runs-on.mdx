...
<Steps>
  ...
  {/* <Step>
  ### <StepNumber/> Validate configuration

  Validate the configuration of the Runs On component:

  <EmbedFile fileName="examples/snippets/stacks/workflows/github.yaml" />
  ...
  <File title="MyOrg/MyInfraRepo/.github/runs-on.yaml">
      ```yaml
