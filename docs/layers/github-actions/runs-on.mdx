...
<Steps>
  ...
  Here is a sample configuration in a `.github` Repository, typically used for shared configurations:
  ...
  Here is an example of extending your Organization's configuration in an individual Repository:
