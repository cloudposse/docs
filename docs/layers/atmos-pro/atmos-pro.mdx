...
- Remove "coming soon" banner when appropriate
*/}
...
Atmos Pro is coming soon! 

Our team is actively developing Atmos Pro and its exciting new capabilities. In the meantime, explore the documentation below for a preview of what's ahead. We'll provide full details and launch timing as we approach the official release date.
