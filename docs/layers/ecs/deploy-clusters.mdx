...
<Steps>
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="vendor" fileName="quickstart/platform/ecs" />
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/ecs-acm" fileName="quickstart/platform/ecs" />
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/clusters" fileName="quickstart/platform/ecs" />
...
- [ECS Component](https://github.com/cloudposse-terraform-components/aws-ecs)
- [ECS Services Component](https://github.com/cloudposse-terraform-components/aws-ecs-service)
