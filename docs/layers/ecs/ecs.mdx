...
custom_edit_url: https://github.com/cloudposse/refarch-scaffold/blob/main/docs/docs/fundamentals/ecs.md
---
...
#### Autoscaling
The cluster component has the ability to scale with a variety of options. Fargate provides a serverless way of scaling. Spot instances provide a cheaper way to run instances than on demand ec2.
you can mix these options to provide a cost effective and scalable solution.
```yaml
        name: ecs
...
1. [`ecs` component](/components/library/aws/ecs/)
2. [`ecs-service` component](/components/library/aws/ecs-service/)
