...
[the detailed documentation](/layers/accounts/tutorials/manual-configuration/) for edge cases.
...
Follow the [prerequisites steps in the How-to Get Started guide](/layers/foundation/#0-prerequisites).
...
1. [Create a `SuperAdmin` IAM User](/layers/accounts/tutorials/how-to-create-superadmin-user/). Do not enable "console
...
[the detailed documentation](/layers/accounts/tutorials/manual-configuration/#optional-enable-regions)
