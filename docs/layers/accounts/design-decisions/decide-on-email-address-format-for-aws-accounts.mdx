...
:::info Office 365 has finally added support for
...
Follow
[this guide to set up slack forwarding](/reference-architecture/setup/cold-start/how-to-set-up-aws-email-notifications/).
