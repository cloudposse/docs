...
:::tip This is our recommended approach.

:::

:::note It is advised to keep the names of accounts as short as possible because of resources with low max character
limits [AWS Resources Limitations](/resources/aws/aws-feature-requests-and-limitations)
...
:::caution Not recommended because there’s not enough isolation.
