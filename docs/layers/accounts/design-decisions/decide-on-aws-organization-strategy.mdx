...
:::tip Cloud Posse recommends starting with a **Net-New Organization**
...
which will serve as a net-new AWS organization (e.g. top-level payer account). Use transit gateway or VPC peering
between heritage accounts and new accounts.
...
:::info Companies with an AWS Enterprise Agreement (EA) can arrange for consolidated invoicing by speaking with their
AWS Account Representative.

:::

:::caution Reserved Instances and AWS Savings Plans cannot be shared across organizations.
...
:::danger Cloud Posse does not prefer to work with **Existing Organizations** due to the liability. Cloud Posse does not
know your organization as well as you do, and in order for us to manage an organization with Terraform we need to be
Organizational Admins.

:::

:::caution Cloud Posse recommends using the **Model Organization** pattern if you wish to use an **Existing
Organization**.
...
:::caution Cloud Posse cannot estimate the time it will take your team to follow the documentation and implement it in
...
:::danger We do not recommend this pattern if Release Engineering is in scope with your engagement with Cloud Posse.
