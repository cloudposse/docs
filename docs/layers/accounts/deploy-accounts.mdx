  ...
  <Step>
    ...
    **Alternative: Use AWS CLI**
    ...
    <Note title="Terraform Alternative">
      This quota increase can also be requested through our [account-quotas](https://github.com/cloudposse-terraform-components/aws-account-quotas) component, but it's generally faster to handle this manually or through the API since it's a one time request.
    </Note>
  </Step>
