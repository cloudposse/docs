---
title: "Old Cold Start Components (Deprecated)"
sidebar_label: "Cold Start (Deprecated)"
...
Learn more about the [sso](https://github.com/cloudposse-terraform-components/aws-sso) component.
