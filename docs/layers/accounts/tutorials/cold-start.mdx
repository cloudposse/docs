...
This cold start documentation is being updated for the new architecture that uses:
- **Static `account_map` variable** instead of account-map component
- **Atmos Auth** for authentication instead of Leapp
- **Permission Sets** instead of aws-teams/aws-team-roles
:::
