...
<Steps>
  ...
  <Step>
    ...
    **Stage Mixin** (`stacks/mixins/stage/foobar.yaml`):
    ...
    **Account Defaults** (`stacks/orgs/acme/core/foobar/_defaults.yaml`):
    ...
    **Account Settings** (`stacks/orgs/acme/core/foobar/global-region/baseline.yaml`):
    ...
    **AWS Team Roles** (`stacks/orgs/acme/core/foobar/global-region/identity.yaml`):
    ...
    **Regional Stack** (`stacks/orgs/acme/core/foobar/us-east-1/baseline.yaml`):
