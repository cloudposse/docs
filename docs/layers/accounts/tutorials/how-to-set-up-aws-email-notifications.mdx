...
<Steps>
  1. ## Create the shared Slack channel (under Slack Connect):
     (see also: [How to Provision Shared Slack Channels](/reference/how-to-provision-shared-slack-channels/) )
     <img src="/assets/refarch/image-20211016-221505.png" />

  2. ## Generate the Slack channel's email address (at the top of the newly-created Slack channel):
     <img src="/assets/refarch/image-20211016-221515.png" /><br/>
  ...
  3. ## Set up email forwarding (example: G Suite / Google Workspace)
     ...
     <img src="/assets/refarch/image-20211016-221527.png" /><br/>
