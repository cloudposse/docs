...
<Steps>
  <Step>
    ...
    Consult the [dns-primary component documentation](https://github.com/cloudposse-terraform-components/aws-dns-primary) for more information.

    The delegated DNS zones insert their `NS` records into the primary DNS zone; thus they are mostly automated.
    Consult the [dns-delegated component documentation](https://github.com/cloudposse-terraform-components/aws-dns-delegated) for more information.
