...
| Steps                      | Actions                             |
| -------------------------- | ----------------------------------- |
| Deploy ECR repositories    | `atmos workflow deploy/ecr -f quickstart/foundation/baseline`      |
...
<Steps>
  ...
  <AtmosWorkflow workflow="deploy/ecr" fileName="quickstart/foundation/baseline" />
