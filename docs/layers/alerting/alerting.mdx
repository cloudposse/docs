...
Alerting goes hand in hand with [monitoring](/layers/monitoring/monitoring). When a system is monitored properly, only the right people are notified when something goes wrong.

:::important

This Quick Start assumes you have read through [the Monitoring Quick Start](/layers/monitoring/monitoring)
...
[This article](/layers/alerting/opsgenie/opsgenie) goes more in-depth on some of the above topics.
