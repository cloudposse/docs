...
<Steps>
  <Step>
    ...
    <TaskList>
      ...
      - [ ] Review Cloud Posse’s [Architectural Design Records (ADRs)](/resources/adrs/adrs), which may not
  ...
  <Step>
    ...
    <TaskList>
      - [ ] Review [Leapp](/layers/identity/tutorials/leapp/leapp) and
            [How to Use Leapp to Authenticate with AWS](/layers/identity/tutorials/leapp/leapp)
      - [ ] Review why we
