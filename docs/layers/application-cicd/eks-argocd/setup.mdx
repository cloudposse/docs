...
<Steps>
  ...
  <Step>
    ...
    Please see [ArgoCD Integrations: How to create an AWS Identity Center Application](/reference-architecture/how-to-guides/integrations/argocd/identity-center-apps) and follow all steps.
  </Step>
