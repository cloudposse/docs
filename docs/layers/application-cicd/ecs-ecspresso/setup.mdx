...
<details>
<summary>We place all workflows inside the example app for a couple of reasons</summary>
...
3. Customizations can be done on a single repo before bringing them to your organization's shared workflow repository.
...
<Steps>
  ...
  <Step>
    ...
    <Admonition title="GitHub Composite Actions">
