...
custom_edit_url: https://github.com/cloudposse/refarch-scaffold/blob/main/docs/docs/fundamentals/release-engineering.md
---
...
- [**Dockerized App on EKS with ArgoCD**](/reference-architecture/fundamentals/release-engineering/dockerized-eks-argocd)
- [**Dockerized App on ECS with Ecspresso**](/reference-architecture/fundamentals/release-engineering/dockerized-ecs-ecspresso)
- [**Lambda App**](/reference-architecture/fundamentals/release-engineering/lambda)
