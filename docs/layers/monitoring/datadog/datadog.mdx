...
<img src="/assets/refarch/image-20211006-041301.png" /><br/>
...
SLOs Datadog Setup Page: [https://app.datadoghq.com/slo](https://app.datadoghq.com/slo?_gl=1*w89f70*_ga*OTkwNTc4OTY1LjE2MjYzMDAyMjI.*_ga_KN80RDFSQK*MTYzMzM3ODc3Mi4yOC4wLjE2MzMzNzg3NzIuMA) and terraform provider: [https://registry.terraform.io/providers/DataDog/datadog/latest/docs/reference/service_level_objective](https://registry.terraform.io/providers/DataDog/datadog/latest/docs/reference/service_level_objective)
