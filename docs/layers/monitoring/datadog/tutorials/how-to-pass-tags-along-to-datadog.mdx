...
Once Tags are set we can then send app-specific alerts to specific teams: [How to Implement Incident Management with OpsGenie](/layers/alerting/opsgenie/opsgenie)
