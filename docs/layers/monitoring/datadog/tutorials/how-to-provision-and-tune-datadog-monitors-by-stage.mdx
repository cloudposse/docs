...
See [How to Use Multiple Infrastructure Repositories with Spacelift?](/layers/spacelift/tutorials/how-to-use-multiple-infrastructure-repositories-with-spacelift) for one approach to manage monitors using terraform.
