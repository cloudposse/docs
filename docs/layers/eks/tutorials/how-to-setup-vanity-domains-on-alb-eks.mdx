---
title: How to Setup Vanity Domains
sidebar_label: "Setup Vanity Domains on an ALB"
tags:
  - network
  - dns
  - alb
...
After setting up your [Network Architecture](/layers/network/network) you will have 2 hosted zones in each platform account.
