...
<Intro>
  ...
  clusters, plugin management, and Kubernetes integration. We present some
  recommended strategies and considerations for deploying Argo CD, addressing
  potential risks, and detailing common deployment patterns.
</Intro>
...
<img src="/assets/refarch/iodjbrmutm7dwt1j0ynbbrlenmin0mvzkin285ndlsyoeneozwxoddrfraohaxsh" />
<br />
...
1. Render Helm charts to manifests, then proceed as usual.

1. (Secrets and Secret Operators) Use ExternalSecrets Operator

1. **Deploy** **<i>generic Lambda</i>**

1. Convert to Serverless Framework

1. Convert to Terraform

1. **Deploy** **<i>Serverless Framework Applications</i>**

1. Serverless applications render to Cloudformation. See Cloudformation.

1. Wrap Cloudformation in a Custom Resource

1. **Deploy Infrastructure with** **<i>Cloudformation</i>**

1. [https://github.com/linki/cloudformation-operator](https://github.com/linki/cloudformation-operator)

1. **Deploy** **<i>Single Page Application</i>** **to S3**

1. This does not fit well into the

1. **Deploy Infrastructure with** **<i>Terraform</i>**
...
1. While it works, it’s a bit advanced to express.

1. **Deploy** **<i>Database Migrations</i>**
...
1. Standard kubernetes Jobs calling migration tool
...
<img src="/assets/refarch/ibuhh3gf6dafekjoz7d2i2f0xrgvorppoqdupvh6yrbsnorgsvkn2j349hmy9n15" />
<br />
...
####### _Example 1: acme/****argo cd-deploy-preview****/uw2-stg/argo cd/pr2-example1.yaml (artifact)_
...
<img src="/assets/refarch/skcm9r9ztzks7drtb7w-e_uou4glaqjb_kzy3fy_ul1ot2q6fcwz40bumnll84st" />
<br />
