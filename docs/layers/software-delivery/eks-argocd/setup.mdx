...
<Steps>
  <Step>
    ...
    <AtmosWorkflow workflow="vendor" fileName="quickstart/platform/software-delivery" />
  </Step>
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/argocd-repos" fileName="quickstart/platform/software-delivery" />
  ...
  <Step>
    ...
    <AtmosWorkflow workflow="deploy/argocd" fileName="quickstart/platform/software-delivery" />
  </Step>
