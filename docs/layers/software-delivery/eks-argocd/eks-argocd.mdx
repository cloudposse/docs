...
- [`eks/argocd`](https://github.com/cloudposse-terraform-components/aws-eks-argocd): This component is responsible for provisioning [ArgoCD](https://argoproj.github.io/cd/).
- [`argocd-repo`](https://github.com/cloudposse-terraform-components/aws-argocd-github-repo): This component is responsible for creating and managing an ArgoCD desired state repository.
- [`sso-saml-provider`](https://github.com/cloudposse-terraform-components/aws-sso-saml-provider): This component reads sso credentials from SSM Parameter store and provides them as outputs
