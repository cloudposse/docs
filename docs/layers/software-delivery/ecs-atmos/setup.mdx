...
<Steps>
  <Step>
    ...
    <Admonition type="info" title="Platform Infrastructure">
      These components are typically deployed once and shared across multiple applications. See the [ECS Cluster](/library/aws/ecs/) documentation for detailed setup instructions.
    </Admonition>
  </Step>
