...
<Intro>
  To build a reliable infrastructure, we must start with a solid foundation. Our reference architecture is designed with best practices to ensure robustness and reliability from the ground up. As part of this process, you’ll make critical design decisions that will shape your infrastructure. Next, you’ll provision your AWS Organizations, accounts, networks, DNS, and fine-grained IAM roles and policies. Once your foundation is complete, you’ll be ready to build a platform to deliver your applications.
</Intro>

<Steps>

  <Step>
    ## <StepNumber/> Set up you project
