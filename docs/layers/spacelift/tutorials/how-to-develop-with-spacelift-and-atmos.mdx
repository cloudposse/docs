...
- Destroying a component is not always easy (for good and bad reasons). See [How to Destroy a Component using `atmos` or Spacelift](/layers/spacelift/tutorials/how-to-destroy-a-component-using-atmos-or-spacelift) for details.
...
If you haven’t yet signed up for Spacelift, see [How to Sign Up for Spacelift](/layers/spacelift/spacelift).

Once the Spacelift account is set up, follow the

## How to Destroy a Spacelift stack and the components?

See [How to Destroy a Component using `atmos` or Spacelift](/layers/spacelift/tutorials/how-to-destroy-a-component-using-atmos-or-spacelift)
