...
sidebar_label: "Worker Pool Architecture"
...
:::caution
Spacelift Enterprise subscription (or trial) is required to use self-hosted workers. See [How to Sign Up for Spacelift](/layers/spacelift/spacelift) for details.
