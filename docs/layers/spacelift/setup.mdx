...
First, sign up for Spacelift. Follow these steps, and see [the detailed documentation](/layers/spacelift/tutorials/how-to-sign-up/spacelift) for additional information.
