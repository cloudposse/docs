...
First, sign up for Spacelift. Follow these steps, and see
[the detailed documentation](https://docs.cloudposse.com/reference-architecture/how-to-guides/integrations/spacelift/)
