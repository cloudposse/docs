...
First, make sure you understand why we chose to [Use Spacelift for GitOps with Terraform](/reference-architecture/reference/adrs/use-spacelift-for-gitops-with-terraform).
...
<Note title="Tip">
  Alternatively, you can use our [free GitHub Actions for Atmos with Terraform](/layer/gitops). This is a great way to get started with GitOps and Terraform without any additional cost.
</Note>
