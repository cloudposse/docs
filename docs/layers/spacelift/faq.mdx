...
<Note title="Tip">
  Alternatively, you can use our [free GitHub Actions for Atmos with Terraform](/layers/gitops/gitops). This is a great way to get started with GitOps and Terraform without any additional cost.
</Note>

## Why can’t we start with an entry-level plan?

(See [How to Sign Up for Spacelift](/layers/spacelift/spacelift) )
