...
<Steps>
  ...
  <Step>
    ...
    <Admonition type="tip">
      If you come prepared to the [Customer Workshops](/support/essential), we can spend more time answering your questions or working through hands-on exercises.
    </Admonition>
