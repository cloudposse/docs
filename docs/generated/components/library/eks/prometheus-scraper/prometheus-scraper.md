...
sidebar_label: prometheus-scraper
sidebar_class_name: command
custom_edit_url: https://github.com/cloudposse/terraform-aws-components/blob/main/modules/eks/prometheus-scraper/README.md
