...
sidebar_label: catalog-database
sidebar_class_name: command
custom_edit_url: https://github.com/cloudposse/terraform-aws-components/blob/master/modules/glue/catalog-database/README.md
