---
title: alb-controller-ingress-class
sidebar_label: alb-controller-ingress-class
sidebar_class_name: command
custom_edit_url: https://github.com/cloudposse/terraform-aws-components/blob/master/modules/eks/alb-controller-ingress-class/README.md
