...
custom_edit_url: https://github.com/cloudposse/terraform-aws-components/blob/master/modules/eks/argocd/README.md
...
The `notifictations.tf` file has been renamed to `notifications.tf`. Delete `notifictations.tf` after vendoring these
changes.
