...
custom_edit_url: https://github.com/cloudposse/terraform-aws-components/blob/master/modules/ipam/README.md
...
| <a name="module_ipam"></a> [ipam](#module\_ipam) | aws-ia/ipam/aws | 1.2.1 |
