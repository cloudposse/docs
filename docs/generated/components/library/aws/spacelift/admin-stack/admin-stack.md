---
title: admin-stack
sidebar_label: admin-stack
sidebar_class_name: command
custom_edit_url: https://github.com/cloudposse/terraform-aws-components/blob/master/modules/spacelift/admin-stack/README.md
tags: [terraform, aws, spacelift]
---
