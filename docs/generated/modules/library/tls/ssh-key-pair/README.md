---
title: ssh-key-pair
sidebar_label: ssh-key-pair
sidebar_class_name: command
description: |-
  Terraform module for generating an SSH public key file.
custom_edit_url: https://github.com/cloudposse/terraform-tls-ssh-key-pair/blob/main/README.yaml
---
...
| <a name="input_chmod_command"></a> [chmod\_command](#input\_chmod\_command) | Template of the command executed on the private key file | `string` | `"chmod 600 %v"` | no |
