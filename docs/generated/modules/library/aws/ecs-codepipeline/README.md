---
title: ecs-codepipeline
sidebar_label: ecs-codepipeline
sidebar_class_name: command
description: |-
  Terraform Module for CI/CD with AWS Code Pipeline using GitHub webhook triggers and Code Build for ECS.
custom_edit_url: https://github.com/cloudposse/terraform-aws-ecs-codepipeline/blob/main/README.yaml
---
...
For a complete example, see [examples/complete](https://github.com/cloudposse/terraform-aws-ecs-codepipeline/tree/main/examples/complete).

For automated tests of the complete example using `bats` and `Terratest`, see [test](https://github.com/cloudposse/terraform-aws-ecs-codepipeline/tree/main/test).
