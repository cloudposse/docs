---
title: vpc-flow-logs-s3-bucket
sidebar_label: vpc-flow-logs-s3-bucket
...
custom_edit_url: https://github.com/cloudposse/terraform-aws-vpc-flow-logs-s3-bucket/blob/main/README.yaml
---
...
For a complete example, see [examples/complete](https://github.com/cloudposse/terraform-aws-vpc-flow-logs-s3-bucket/tree/main/examples/complete).

For automated tests of the complete example using [bats](https://github.com/bats-core/bats-core) and [Terratest](https://github.com/gruntwork-io/terratest)
(which tests and deploys the example on Datadog), see [test](https://github.com/cloudposse/terraform-aws-vpc-flow-logs-s3-bucket/tree/main/test).
