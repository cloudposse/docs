---
title: eks-spotinst-ocean-nodepool
sidebar_label: eks-spotinst-ocean-nodepool
...
custom_edit_url: https://github.com/cloudposse/terraform-aws-eks-spotinst-ocean-nodepool/blob/main/README.yaml
---
...
- [`examples/complete`](https://github.com/cloudposse/terraform-aws-eks-spotinst-ocean-nodepool/tree/main/examples/complete/) - complete example of using this module
