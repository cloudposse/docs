...
custom_edit_url: https://github.com/cloudposse/terraform-aws-cloudtrail/blob/main/README.yaml
---
...
For a complete example, see [examples/complete](https://github.com/cloudposse/terraform-aws-cloudtrail/tree/main/examples/complete).
