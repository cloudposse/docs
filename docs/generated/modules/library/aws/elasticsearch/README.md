...
custom_edit_url: https://github.com/cloudposse/terraform-aws-elasticsearch/blob/main/README.yaml
---
...
- [`examples/complete`](https://github.com/cloudposse/terraform-aws-elasticsearch/tree/main/examples/complete)
...
- [`test`](https://github.com/cloudposse/terraform-aws-elasticsearch/tree/main/test)
