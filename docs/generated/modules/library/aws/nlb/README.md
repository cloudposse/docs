...
custom_edit_url: https://github.com/cloudposse/terraform-aws-nlb/blob/main/README.yaml
---
...
For a complete example, see [examples/complete](https://github.com/cloudposse/terraform-aws-nlb/tree/main/examples/complete).

For automated test of the complete example using `bats` and `Terratest`, see [test](https://github.com/cloudposse/terraform-aws-nlb/tree/main/test).
