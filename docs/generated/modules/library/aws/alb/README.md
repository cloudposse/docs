...
custom_edit_url: https://github.com/cloudposse/terraform-aws-alb/blob/main/README.yaml
---
...
For a complete example, see [examples/complete](https://github.com/cloudposse/terraform-aws-alb/tree/main/examples/complete).

For automated test of the complete example using `bats` and `Terratest`, see [test](https://github.com/cloudposse/terraform-aws-alb/tree/main/test).
