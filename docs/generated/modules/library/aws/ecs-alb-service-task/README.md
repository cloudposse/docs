---
title: ecs-alb-service-task
sidebar_label: ecs-alb-service-task
sidebar_class_name: command
description: |-
  Terraform module to create an ECS Service for a web app (task), and an ALB target group to route requests.
custom_edit_url: https://github.com/cloudposse/terraform-aws-ecs-alb-service-task/blob/main/README.yaml
---
...
For a complete example, see [examples/complete](https://github.com/cloudposse/terraform-aws-ecs-alb-service-task/tree/main/examples/complete).

For automated test of the complete example using `bats` and `Terratest`, see [test](https://github.com/cloudposse/terraform-aws-ecs-alb-service-task/tree/main/test).
