...
custom_edit_url: https://github.com/cloudposse/terraform-aws-rds-cluster/blob/main/README.yaml
---
...
For a complete example, see [examples/complete](https://github.com/cloudposse/terraform-aws-rds-cluster/tree/main/examples/complete).

For automated tests of the complete example using [bats](https://github.com/bats-core/bats-core) and [Terratest](https://github.com/gruntwork-io/terratest) (which tests and deploys the example on AWS), see [test](https://github.com/cloudposse/terraform-aws-rds-cluster/tree/main/test).

[Basic example](https://github.com/cloudposse/terraform-aws-rds-cluster/tree/main/examples/basic)
...
[Serverless Aurora MySQL 5.6](https://github.com/cloudposse/terraform-aws-rds-cluster/tree/main/examples/serverless_mysql)
...
[Serverless Aurora 2.07.1 MySQL 5.7](https://github.com/cloudposse/terraform-aws-rds-cluster/tree/main/examples/serverless_mysql57)
...
[With cluster parameters](https://github.com/cloudposse/terraform-aws-rds-cluster/tree/main/examples/with_cluster_parameters)
...
[With enhanced monitoring](https://github.com/cloudposse/terraform-aws-rds-cluster/tree/main/examples/enhanced_monitoring)
...
Review the [complete example](https://github.com/cloudposse/terraform-aws-rds-cluster/tree/main/examples/complete) to see how to use this module.
