...
confluence: https://cloudposse.atlassian.net/wiki/spaces/REFARCH/pages/1183219789/Proposed%3A+Use+ISO-8601+Date+Index+for+ADRs
sidebar_position: 200
custom_edit_url: https://github.com/cloudposse/refarch-scaffold/tree/main/docs/docs/reference/adrs/proposed-use-iso-8601-date-index-for-adrs.md
---
...
- [Architectural Design Records (ADRs)](/reference-architecture/reference/adrs)
