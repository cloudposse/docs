...
confluence: https://cloudposse.atlassian.net/wiki/spaces/REFARCH/pages/1223819339
sidebar_position: 100
custom_edit_url: https://github.com/cloudposse/refarch-scaffold/tree/main/docs/docs/reference/adrs/use-environment-variables-for-configuration-12-factor.md
---
...
- See also [Use SSM over ASM for Infrastructure](/reference-architecture/reference/adrs/use-ssm-over-asm-for-infrastructure)
