...
- Cloud Posse does use mixins, but generally they are avoided. Instead, we recommend [using the override pattern](/learn/component-development/component-development#how-can-terraform-modules-or-resources-be-added-to-a-component). This ADR should be updated to reflect the latest decision.
