...
confluence: https://cloudposse.atlassian.net/wiki/spaces/REFARCH/pages/1176765189/Proposed%3A+Use+AWS+Federated+IAM+over+AWS+SSO
sidebar_position: 200
custom_edit_url: https://github.com/cloudposse/refarch-scaffold/tree/main/docs/docs/reference/adrs/proposed-use-aws-federated-iam-over-aws-sso.md
---
