...
confluence: https://cloudposse.atlassian.net/wiki/spaces/REFARCH/pages/1205928052/Operational+Readiness
sidebar_position: 100
custom_edit_url: https://github.com/cloudposse/refarch-scaffold/tree/main/docs/docs/reference/operational-readiness.md
---
...
:::info
If you’re new to all of this, you will want to start with [How to Get Started](/reference-architecture/fundamentals).
...
- You have developed a [Helm](/reference-architecture/reference/helm) chart (if you’re using EKS)
...
- You can explain the core [Concepts](/fundamentals/concepts) and use them as part of your design process

- You are current on all of the [Conventions](/reference-architecture/reference/conventions) used
...
- You are regularly performing upgrades to keep everything current (see [How to Keep Everything Up to Date](/reference-architecture/how-to-guides/upgrades/how-to-keep-everything-up-to-date))
