...
Using chamber you can perform all standard CRUD operations on secrets stored in [AWS SSM](/reference/glossary/ssm) and execute commands with environment variables populated from the secrets.
