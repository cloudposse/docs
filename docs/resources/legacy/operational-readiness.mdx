...
- You have developed a [Helm](/resources/legacy/helm) chart (if you’re using EKS)
...
- You can explain the core [Concepts](/resources/legacy/fundamentals/concepts) and use them as part of your design process
