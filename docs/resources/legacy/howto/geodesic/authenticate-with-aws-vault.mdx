...
recommends this workflow. See** [Authenticate with AWS using Leapp](/resources/legacy/howto/geodesic/authenticate-with-leapp) **for the currently recommended procedure.**
