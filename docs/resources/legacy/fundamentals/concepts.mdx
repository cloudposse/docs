...
You can see an example of this pattern in the [dns-primary](https://github.com/cloudposse-terraform-components/aws-dns-primary) and [dns-delegated](https://github.com/cloudposse-terraform-components/aws-dns-delegated) components.
