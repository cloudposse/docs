...
- [How to Manage Explicit Component Dependencies with Spacelift](/resources/deprecated/spacelift/tutorials/how-to-manage-explicit-component-dependencies-with-spacelift)
...
:::info
Make sure you’re already familiar with the core [Concepts](/resources/legacy/fundamentals/concepts).
