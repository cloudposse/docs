...
<Note title="Tip">
  Alternatively, you can use our [free GitHub Actions for Atmos with Terraform](/resources/deprecated/gitops). This is a great way to get started with GitOps and Terraform without any additional cost.
</Note>
