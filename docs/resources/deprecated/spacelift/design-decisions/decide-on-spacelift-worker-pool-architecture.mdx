...
:::caution
Spacelift Enterprise subscription (or trial) is required to use self-hosted workers. See [How to Sign Up for Spacelift](/resources/deprecated/spacelift) for details.
...
- [How to Sign Up for Spacelift](/resources/deprecated/spacelift)

- [spacelift-worker-pool](https://github.com/cloudposse-terraform-components/aws-spacelift-worker-pool) (component)
