...
<Steps>
  ...
  <Step>
    ...
    **If no team already exists** follow this guide to create a new opsgenie team [How to Create New Teams in OpsGenie](/resources/deprecated/alerting/opsgenie/how-to-create-new-teams-in-opsgenie).
  </Step>

  <Step>
    ## <StepNumber/> Add Users to Teams

    Once a team exists we need people to respond to the alert. Follow [How to Add Users to a Team in OpsGenie](/resources/deprecated/alerting/opsgenie/how-to-add-users-to-a-team-in-opsgenie)  to add people to a team.
  ...
  <Step>
    ...
    Follow this guide to create new monitors: [datadog-monitor](https://github.com/cloudposse-terraform-components/aws-datadog-monitor)
  </Step>
