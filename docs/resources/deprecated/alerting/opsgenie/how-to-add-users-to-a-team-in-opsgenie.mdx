...
Assuming you are using the [opsgenie-team](https://github.com/cloudposse-terraform-components/aws-opsgenie-team) component with `ignore_team_members` set to `false`
