...
Please follow the sign up steps in [How to Sign Up for OpsGenie](/resources/deprecated/alerting/opsgenie/how-to-sign-up-for-opsgenie/)
...
and
[How to Implement Incident Management with OpsGenie](/resources/deprecated/alerting).
