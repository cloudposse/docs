...
<Tabs>
  <TabItem value="quickstart" label="Quickstart (DIY)">
    ...
    <Steps>
      - Initiate a "Quickstart" [GitHub Sponsorship](https://github.com/sponsors/cloudposse/sponsorships?tier_id=472843) to receive all the configurations.
...
Plus, we provide [multiple support options](/support) if you get stuck.
