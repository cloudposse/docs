...
<Steps>
  ...
  <Step>
    ...
    The [**Community**](/community) section is for connecting with others who are building infrastructure with Cloud Posse's open source tools and reference architecture. It's a place to share experiences, learn from peers, and collaborate on common challenges.
