---
title: "Getting Started with the Reference Architecture"
sidebar_label: "Getting Started"
sidebar_position: 1
description: "A comprehensive introduction to the Cloud Posse Reference Architecture toolchain, terminology, conventions, and repository layout."
...
<Slide layout="content">
  ...
  <table style={{width: '80%', margin: '1rem auto', borderCollapse: 'collapse'}}>
    <thead>
      <tr style={{background: '#000', color: '#fff'}}>
        <th style={{padding: '0.5rem', border: '1px solid #333'}}>Host</th>
        <th style={{padding: '0.5rem', border: '1px solid #333'}}>Container</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td style={{padding: '0.5rem', border: '1px solid #333'}}>~/ ($HOME dir)</td>
        <td style={{padding: '0.5rem', border: '1px solid #333'}}>/localhost/</td>
      </tr>
      <tr>
        <td style={{padding: '0.5rem', border: '1px solid #333'}}>$PROJECT_ROOT/rootfs/</td>
