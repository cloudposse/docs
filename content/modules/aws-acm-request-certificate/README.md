---
title: aws-acm-request-certificate
sidebar_label: aws-acm-request-certificate
...
custom_edit_url: https://github.com/cloudposse/terraform-aws-acm-request-certificate/edit/master/README.md
---

# Component: `aws-acm-request-certificate`
Terraform module to request an ACM certificate for a domain and add a CNAME record to the DNS zone to complete certificate validation
