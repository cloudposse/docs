---
title: aws-alb-target-group-cloudwatch-sns-alarms
sidebar_label: aws-alb-target-group-cloudwatch-sns-alarms
sidebar_class_name: command
description: |-
  Terraform module for creating alarms for tracking important changes and occurrences from ALBs.
custom_edit_url: https://github.com/cloudposse/terraform-aws-alb-target-group-cloudwatch-sns-alarms/edit/master/README.md
---

# Component: `aws-alb-target-group-cloudwatch-sns-alarms`
Terraform module for creating alarms for tracking important changes and occurrences from ALBs.
