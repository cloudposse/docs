...
sidebar_label: aws-kinesis-stream
sidebar_class_name: command
description: |-
  Terraform module to deploy an [Amazon Kinesis Data Stream](https://aws.amazon.com/kinesis/data-streams/) on AWS.
custom_edit_url: https://github.com/cloudposse/terraform-aws-kinesis-stream/edit/main/README.md
---

# Component: `aws-kinesis-stream`
Terraform module to deploy an [Amazon Kinesis Data Stream](https://aws.amazon.com/kinesis/data-streams/) on AWS.
