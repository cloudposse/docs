---
title: aws-config-storage
sidebar_label: aws-config-storage
...
custom_edit_url: https://github.com/cloudposse/terraform-aws-config-storage/edit/master/README.md
---

# Component: `aws-config-storage`
This module creates an S3 bucket suitable for storing `AWS Config` data.
