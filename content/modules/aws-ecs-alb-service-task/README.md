---
title: aws-ecs-alb-service-task
sidebar_label: aws-ecs-alb-service-task
sidebar_class_name: command
description: |-
  Terraform module to create an ECS Service for a web app (task), and an ALB target group to route requests.
custom_edit_url: https://github.com/cloudposse/terraform-aws-ecs-alb-service-task/edit/master/README.md
---

# Component: `aws-ecs-alb-service-task`
Terraform module to create an ECS Service for a web app (task), and an ALB target group to route requests.
