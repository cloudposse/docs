---
title: cross-region-hub-connector
sidebar_label: cross-region-hub-connector
sidebar_class_name: command
description: cross-region-hub-connector
---
...
This component is deployed to each off-region tgw/hub.
meaning if your home region is `region-a`, and you just created a `tgw/hub` in `region-a` and `region-b`. To peer them, deploy this
to `region-b`
...
| Name | Type |
|------|------|
| [aws_ec2_transit_gateway_peering_attachment.tgw_peering](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ec2_transit_gateway_peering_attachment) | resource |
| [aws_ec2_transit_gateway_peering_attachment_accepter.tgw_peering_accepter](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ec2_transit_gateway_peering_attachment_accepter) | resource |
| [aws_ec2_transit_gateway_route_table_association.tgw_rt_associate_peering_cross_region](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ec2_transit_gateway_route_table_association) | resource |
| [aws_ec2_transit_gateway_route_table_association.tgw_rt_associate_peering_in_region](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ec2_transit_gateway_route_table_association) | resource |
...
| <a name="input_home_region"></a> [home\_region](#input\_home\_region) | Acceptors region config. Describe the transit gateway that should accept the peering | <pre>object({<br/>    tgw_name_format = string<br/>    tgw_stage_name  = string<br/>    tgw_tenant_name = string<br/>    region          = string<br/>    environment     = string<br/>  })</pre> | n/a | yes |
...
| <a name="input_this_region"></a> [this\_region](#input\_this\_region) | Initiators region config. Describe the transit gateway that should originate the peering | <pre>object({<br/>    tgw_stage_name  = string<br/>    tgw_tenant_name = string<br/>  })</pre> | n/a | yes |
