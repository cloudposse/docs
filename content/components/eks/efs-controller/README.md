---
title: efs-controller
sidebar_label: efs-controller
sidebar_class_name: command
description: efs-controller
---

# Component: `efs-controller`
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_efs"></a> [efs](#module\_efs) | cloudposse/stack-config/yaml//modules/remote-state | 0.22.4 |
| <a name="module_efs_controller"></a> [efs\_controller](#module\_efs\_controller) | cloudposse/helm-release/aws | 0.5.0 |
...
| <a name="input_efs_component_name"></a> [efs\_component\_name](#input\_efs\_component\_name) | The name of the efs component | `string` | `"efs"` | no |
