...
sidebar_label: aws-node-termination-handler
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_aws_node_termination_handler"></a> [aws\_node\_termination\_handler](#module\_aws\_node\_termination\_handler) | cloudposse/helm-release/aws | 0.5.0 |
